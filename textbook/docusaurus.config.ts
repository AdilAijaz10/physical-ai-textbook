...
const config: Config = {
  ...
  tagline: 'A Comprehensive Textbook on ROS 2, Gazebo, NVIDIA Isaac, and Vision-Language-Action Systems',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          to: '/docs/assessment-guidelines',
          label: 'Assessment',
          position: 'left'
        },
        {
          href: 'https://github.com/physical-ai-textbook/textbook',
          label: 'GitHub',
          position: 'right',
        },
      ],
